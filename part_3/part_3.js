...
to chose specific data from Two tables and select them as one table 
...
to save the values that users inter in typing box
...
updateOne to update the value in the schema
